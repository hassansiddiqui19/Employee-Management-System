...
<div className='mt-4'>
    <button className=' w-[90%] bg-gradient-to-l from-cyan-300 to-blue-400 rounded-full  px-3  py-2 text-xs font-semibold  text-white absolute bottom-3 left-4'>Completed</button>
</div>
</div>
  )
}
